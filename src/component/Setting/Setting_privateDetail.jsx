  ...
  return (
    <div className="relative flex min-h-screen bg-[#000]">
      ...
      <div className="absolute left-85 top-30 bg-[#434343] w-280 h-149 flex flex-col justify-between text-2xl border rounded-md p-3">
        ...
        <div className="absolute left-90 top-5 bg-amber-50 w-185 h-139 flex flex-col justify-start text-2xl border rounded-lg p-3">อณุญาตให้ผู้ใช้พูดถึงฉัน
          <p className="m-5 text-lg">ทุกคนจะสามารถพูดถึงคุณในทุโพสต์ เเละความคิดเห็น</p>
